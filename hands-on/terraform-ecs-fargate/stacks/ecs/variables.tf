...
variable "vpc_id" {
  description = "VPC ID resolved from the networking stack state."
  type        = string
}

variable "alb_subnet_ids" {
  description = "Public subnet IDs resolved from the networking stack state."
  type        = list(string)
}

variable "ecs_subnet_ids" {
  description = "Private subnet IDs resolved from the networking stack state."
  type        = list(string)
}
